...
/* ------------------------- PACKAGEPACKAGE DESCRIPTION -----------------------
	...
	ARB Web Service App is a simple and handy web service app for adserver/banner rotator.
	It is built with php and js and its very small package.
	By this package you can serve ads/banner service to your client website through a simple code and its very fast to load.
	Please share this if you find out this package helpful.
	Thank you ...
